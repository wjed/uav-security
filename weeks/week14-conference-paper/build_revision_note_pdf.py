# -*- coding: utf-8 -*-
"""
Render REVISION_NOTE.md to a submittable PDF in the project house style.
...
SRC = HERE / 'REVISION_NOTE.md'
OUT = HERE / 'week14_revision_note.pdf'
...
class PDF(FPDF):
    def header(self):
        ...
        self.cell(0, 5, 'Revision Note  |  Group 1  |  '
                        'Receiver-Domain Behavioral Probing', align='L')
        self.ln(6)
...
pdf.multi_cell(0, 8.0, 'Revision Note',
               new_x=XPos.LMARGIN, new_y=YPos.NEXT)
