...
\midrule
\multicolumn{2}{@{}l}{\textit{Data and federation}}\\
Clients / compromised     & 10 / 2 (IDs $U_9$, $U_{10}$) \\
Data split                & IID, 60/40 authentic/spoofed \\
Subsample                 & 150{,}000 rows \\
Pool / root / test        & 114{,}000 / 6{,}000 / 30{,}000 \\
Features                  & 10 signal-quality features \\
FL rounds / local epochs  & 12 / 3 \\
Batch size / optimizer    & 512 / Adam, lr $10^{-3}$ \\
Random seeds              & 42, 7, 123 (split fixed at 42) \\
\midrule
\multicolumn{2}{@{}l}{\textit{Model}}\\
Architecture              & $10\text{-}64\text{-}32\text{-}16\text{-}1$ MLP, ReLU, dropout 0.2 \\
Parameters                & 3{,}329 (13.0 KB, float32) \\
\midrule
\multicolumn{2}{@{}l}{\textit{Attack}}\\
Poison ratio              & 40\% of each attacker's spoofed rows \\
Trigger / value           & CN0 / 46.706 dB-Hz ($+0.738$ std) \\
Update scaling $\gamma$   & 3.0 (model replacement) \\
Inflated accuracy         & 0.99 (inflation variant) \\
\midrule
\multicolumn{2}{@{}l}{\textit{Defense (D2)}}\\
Probe features            & 8 features, Cohen's $d \geq 0.05$ \\
Root set size             & 6{,}000 rows \\
Trust gate $\beta,\tau,\rho$ & 1.0 / 2.0 / 0.5 \\
\bottomrule
\end{tabular}
\end{table}
